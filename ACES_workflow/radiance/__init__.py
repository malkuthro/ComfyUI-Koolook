...
from .nodes_color_management import NODE_CLASS_MAPPINGS as COLOR_NODES, NODE_DISPLAY_NAME_MAPPINGS as COLOR_NAMES
...
# Add Color Management nodes
NODE_CLASS_MAPPINGS.update(COLOR_NODES)
NODE_DISPLAY_NAME_MAPPINGS.update(COLOR_NAMES)
