...
| review-pr-fast-koolook-cursor | Quick Cursor/Grok first-pass PR comment; escalate before merge. | `/review-pr-fast-koolook-cursor <n>` |
| review-pr-koolook-cursor | Deep Cursor/Grok v2 batched-verify PR review team. | `/review-pr-koolook-cursor <n>` |
...
- `/review-pr-fast-koolook-cursor` — quick Cursor/Grok first-pass PR comment
- `/review-pr-koolook-cursor` — deep Cursor/Grok v2 batched-verify PR review
