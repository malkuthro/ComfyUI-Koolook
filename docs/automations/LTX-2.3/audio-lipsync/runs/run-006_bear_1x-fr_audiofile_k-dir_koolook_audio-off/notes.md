...
**Scores:** motion: 4/5 · sync: 3/5 · sharp: 4/5
...
## OVERLAY - INFO (verbatim)
    ...
    BASE: Teeth in prompt

## SETUP variables (captured)

- Capture run number: `006 (from runs folder/log)`
- Setup name: `LTX-23-audio_tests_02`
...
- Output name: `Bear_1x-FR_AudioFile_K-Dir_h264_v002`
