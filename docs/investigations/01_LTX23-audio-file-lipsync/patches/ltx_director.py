        ...
        return io.Schema(
            ...
            inputs=[
                ...
                io.String.Input(
                    ...
                    optional=True,
                    tooltip=(
                        "KOOLOOK PATCH (issue #177): JSON dict of Prompt Relay per-stream "
                        "overrides. Empty = upstream defaults. Supported keys: "
                        "video_strength (float), video_window_scale (float), "
                        "audio_strength (float), audio_window_scale (float), audio_epsilon (float). "
                        "Example: {\"video_strength\": 10.0}. Underscore-prefixed keys are ignored."
                    ),
                ),
            ],
            outputs=[
