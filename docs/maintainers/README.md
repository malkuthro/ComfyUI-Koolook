...
| [`published-setups.md`](published-setups.md) | Published workflow setup schema, server-side storage boundary, and read-only catalog API contract for external frontends. |
